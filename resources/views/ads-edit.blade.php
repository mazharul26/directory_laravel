   ...
   <div class="container">
      ...
      <div class="row">      
         ...
         <div class="col-sm-9">
            ...
            @endif     
            <form action="{{url('/myads')}}/{{$ads->id}}" method="post" enctype="multipart/form-data">
               {{ csrf_field() }}
               ...
               <div class="panel panel-default place-an-ads">
                  ...
                  <div class="panel-body">    
                     <p><input type="submit" name="sub" value="&nbsp;&nbsp;&nbsp;Update AD&nbsp;&nbsp;&nbsp;" class="btn btn-success" /> &nbsp;It may take up to 15 minutes for your ad to be fully posted</p>
                  </div>
               </div>
            </form>
         </div>         
