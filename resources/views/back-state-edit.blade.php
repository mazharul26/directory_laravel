         ...
         <div class="col-sm-7">
            <div class="panel panel-default place-an-ads">
               <div class="panel-heading">
                  <h3 class="panel-title" style="display: inline-block">State</h3>
               </div>
               <div class="panel-body">
                  <a href="{{url('/')}}/admin-state" class="btn btn-primary" style="border: 1px solid #fff; margin-bottom: 15px;">All State</a>
                  @if ($errors->any())
                  ...
                  @endif
                  <form action="{{url('/')}}/admin-state/edit" method="post">
                     {{ csrf_field() }}
                     <input type="hidden" name="id" value="{{$sel->id}}" />
                     <div class="email-box">
                        <div class="email-box-left">
                           <label><span class="star">*</span> State Name</label>
                        </div>
                     ...
                     <div class="email-box">
                        ...
                        <div class="email-box-right">
                           <select name="country_id" class="form-control">
                              <option value="1"<?php if($sel->country_id==1) echo " selected"; ?>>Canada</option>
                              <option value="2"<?php if($sel->country_id==2) echo " selected"; ?>>USA</option>
                           </select>
                        </div>
                     </div>
                     <div class="email-box">
