         ...
         <div class="col-sm-7">
            <div class="panel panel-default place-an-ads">
               ...
               <div class="panel-body">
                  <a href="{{url('/')}}/admin-category/create" class="btn btn-primary" style="border: 1px solid #fff; margin-bottom: 15px;">New Category</a>
                  @if (session('msg'))
                  ...
                  <table class="table table-striped table-hover">
                     ...
                     <tr>
                        <td>{{$value->name}}</td>
                        <th><a href="{{url('/')}}/admin-category/edit/{{$value->id}}"><i class="fa fa-pencil-square-o fa-2x"></i></a></th>
                     </tr>
                     @endforeach
                  </table>                  
                  @else
