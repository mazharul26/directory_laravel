      ...
      <div class="row">
         <div class="col-md-12">
            <div class="wel_header">
               <h2>Browse By <span>Free Item</span></h2>
            </div>
         </div>
      </div>
      <!--End of row-->
      <div class="row">
         <div class="col-sm-3">
            <div class="side-menu">
               <p>Free Item</p>
               <ul>
                  <li><a href="{{url('/')}}/free-item"<?php if($act==0) echo ' class="active"' ?>>View all</a></li>
                  @foreach($allDt as $value)
                  @if($value->total > 0)
                  <li><a href="{{url('/')}}/free-item?category={{$value->id}}"<?php if($act==$value->id) echo ' class="active"' ?>>{{$value->name}}({{$value->total}})</a></li>
                  @endif
                  @endforeach
               </ul>
            </div>
